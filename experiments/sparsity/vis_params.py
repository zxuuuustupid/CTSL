...
task_list = ["PU123","PU124","PU134","PU234"]
for task in task_list:
    ...
    ax.plot(x_axis, baseline, label='Teacher', color=color_base, linestyle='-', alpha=0.9, zorder=3)
    ax.plot(x_axis, mid, label='CTSL', color=color_mid, linestyle='-', alpha=0.9, zorder=3)
